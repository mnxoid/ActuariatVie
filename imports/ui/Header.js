    ...
    return (
      ...
      :
        <div onClick={this.click.bind(this)} style={Stylesheet.header(this.state.open)}>
            ...
            <div style={{flex:1,display:"flex",alignItems: 'stretch',margin:'3vw'}}>i: <input ref="i" type="text" style={{backgroundColor: '#333',margin:'3vw',border:0,width:'20vw'}} name="lname"/><button style={{background: '#333',border: 0,margin: '3vw',padding: 0,lineHeight: '100%',textAlign: 'center',flex: 1}} onClick={this.okClick.bind(this)}>OK</button></div>
        </div>
    );
  }
}
